...
// //                   <span className="text-sm font-medium text-sentiment-supportive">Supportive</span>
...
// //                   <span className="text-sm font-medium text-sentiment-critical">Critical</span>
...
const StakeholderSegmentation = () => {
        ...
        {stakeholderData.map((stakeholder) => (
          <Card key={stakeholder.type} className={`shadow-card border-border hover:shadow-strong transition-all duration-300 cursor-pointer bg-gradient-to-br ${stakeholder.bgGradient} border-l-4`}
            ...
            <CardContent className="pt-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between p-2 rounded-lg bg-sentiment-supportive/10">
                  <span className="text-lg font-medium text-sentiment-supportive">Supportive</span>
                  <span className="font-bold text-sentiment-supportive">{stakeholder.sentiment.supportive}</span>
                </div>
                <div className="flex items-center justify-between p-2 rounded-lg bg-sentiment-critical/10">
                  <span className="text-lg font-medium text-sentiment-critical">Critical</span>
                  <span className="font-bold text-sentiment-critical">{stakeholder.sentiment.critical}</span>
                </div>
                <div className="flex items-center justify-between p-2 rounded-lg bg-sentiment-neutral/10">
          ...
          <div style={{ height: '500px' }}>
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={distributionData} margin={{ top: 20, right: 30, left: 20, bottom: 80 }}>
                  ...
                  />
                  <YAxis stroke="hsl(var(--muted-foreground))" />
                  <Tooltip content={<CustomTooltip />} cursor={{ fill: 'hsla(var(--), 0.5)' }} />
                  <Bar dataKey="value" radius={[4, 4, 0, 0]}>
                    {distributionData.map((entry) => (
                      <Cell key={entry.name} fill={entry.fill} />
                    ))}
  ...
  <div className="space-y-3">
    <h4 className="font-semibold text-org-extractive text-xl">Highest Participation</h4>
    <div className="bg-org-extractive/70 p-5 rounded-xl border-l-4 border-org-extractive shadow-sm hover:shadow-md transition-shadow duration-300">
      <p className="text-base font-medium text-gray-700">Extractive Industries (Organization)</p>
      <p className="text-3xl font-bold text-org-extractive mt-1">340 responses</p>
  ...
  {/* Moderate Engagement */}
  <div className="space-y-3">
    <h4 className="font-semibold text-org-manufacturing text-xl">Moderate Engagement</h4>
    <div className="bg-org-manufacturing/20 p-5 rounded-xl border-l-4 border-org-manufacturing shadow-sm hover:shadow-md transition-shadow duration-300">
      <p className="text-base font-medium text-gray-700">Manufacturing (Organization)</p>
      <p className="text-3xl font-bold text-org-manufacturing mt-1">300 responses</p>
  ...
  <div className="space-y-3">
    <h4 className="font-semibold text-individual-student text-xl">Lowest Participation</h4>
    <div className="bg-individual-student/20 p-5 rounded-xl border-l-4 border-individual-student shadow-sm hover:shadow-md transition-shadow duration-300">
      <p className="text-base font-medium text-gray-700">Students (Individual)</p>
      <p className="text-3xl font-bold text-individual-student mt-1">100 responses</p>
